...
<body class="home">
	...
	<div id="main">
		...
		<div class="wrapper">			
			...
			<li class="">
		    <a onclick="trackItemId(${productList.classId},'${productList.itemName}');" href="${imagePathBase}/full/${productList.classId}/${productList.itemName}.jpg" rel="group1" class="fancybox" title="${productList.itemCode}">
	...
	*/
	...
	<script>
		...
		function trackItemId(classId,itemName){
			//alert(itemId);
			datalayer = {
				cid: 		classId,	
				itemName: 	itemName,
			...
			ga('send', 'event', "username:" + datalayer.uname + ", Category ID:" + datalayer.cid + ", Item Name:" + datalayer.itemName);  
		}
	</script>
